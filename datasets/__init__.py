...
# 3-modal datasets (new)
from .vid_single_3m import build as build_vid_single_3m
from .vid_multi_3m import build as build_vid_multi_3m
...
def build_dataset(image_set, args):
    ...
    # tri-modal VID
    if args.dataset_file == 'vid_single_3m':
        return build_vid_single_3m(image_set, args)
    if args.dataset_file == 'vid_multi_3m':
        return build_vid_multi_3m(image_set, args)
